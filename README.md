...
* `GEMINI_API_KEY`: Create a free Gemini API key through Google AI Studio. Link:https://ai.google.dev/gemini-api/docs/api-key
* `COLLEGE_SCORECARD_API_KEY`: Request a free data.gov API key for the College Scorecard API. Link:https://collegescorecard.ed.gov/data/api/
